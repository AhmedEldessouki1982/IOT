...
export type LampDeviceProps = CardProps | FloorProps;

/** Standing / table lamp — visibly smaller ceiling-light glyph on the floorplan. */
export default function LampDevice(props: LampDeviceProps) {
